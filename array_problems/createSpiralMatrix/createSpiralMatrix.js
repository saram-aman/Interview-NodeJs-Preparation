...
const createSpiralMatrixPromise = arrayProblems.createSpiralMatrix(5)
Promise.all(([createSpiralMatrixPromise]))
    .then(([spiralMatrix]) => {
        console.log(spiralMatrix)
    }).catch(error => {
        console.error('Error occurred while creating spiral matrix:', error)
    })