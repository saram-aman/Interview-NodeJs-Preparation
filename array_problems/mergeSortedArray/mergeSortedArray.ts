...
class ArrayProblem {
    ...
    public async mergeSortedArray(): Promise<number[]> {
...
(async () => {
    const array_problem = new ArrayProblem(array1, argument1, array2, argument2);
    console.log(await array_problem.mergeSortedArray());
})();